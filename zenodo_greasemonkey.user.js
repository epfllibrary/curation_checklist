...
function addButtons() {
  ...
  btn.on('click', function(event) {
    ...
    if (text == '') {
      ...
      header += 'As part of our workflow, the dataset will also be listed on Infoscience, similar to the process followed by publications imported from external sources (Web of Science, Scopus, OpenAlex...).\n\n'
